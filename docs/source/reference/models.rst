...
should not exceed the amount of times the *low-resolution* input can be evenly max-pooled to half resolution.
Because of this, users are recommended to keep image resolutions to a power of 2.
